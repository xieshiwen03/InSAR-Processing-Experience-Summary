...
```bash
dispmap_LOS geo_20260722_20260803.diff.unw  10872 5.406 geo_20260722_20260803.diff.los 1/0
```
...
**不在gamma转los方法（终端直接运行）：**
 ``` bash
gdal_calc.py -A geo_20160327_20160420.diff.unw_corrected.tif --outfile=geo_20160327_20160420.diff.los.tif --calc="A*0.004413825" --type=Float32 --format=GTiff --NoDataValue=nan --overwrite
